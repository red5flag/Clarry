pub fn page_token() -> impl IntoToken {
    ...
    col()
        ...
        row()
            ...
            col()
                css("items-center gap-1 min-w-[64px] cursor-pointer")
                act(chain(vec![store_set("ig.viewing.story_id", "bob"), store_set("ig.story.slide_index", "0"), navigate("instagram_story")]))
                block()
                    css("w-14 h-14 rounded-full p-0.5 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex-shrink-0")
            ...
            col()
                css("items-center gap-1 min-w-[64px] cursor-pointer")
                act(chain(vec![store_set("ig.viewing.story_id", "charlie"), store_set("ig.story.slide_index", "0"), navigate("instagram_story")]))
                block()
                    css("w-14 h-14 rounded-full p-0.5 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex-shrink-0")
            ...
            col()
                css("items-center gap-1 min-w-[64px] cursor-pointer")
                act(chain(vec![store_set("ig.viewing.story_id", "diana"), store_set("ig.story.slide_index", "0"), navigate("instagram_story")]))
                block()
                    css("w-14 h-14 rounded-full p-0.5 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex-shrink-0")
        ...
        col()
            ...
            row()
                ...
                block()
                    css("w-9 h-9 rounded-full p-0.5 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 flex-shrink-0 cursor-pointer")
                    act(chain(vec![store_set("ig.viewing.user_id", "charlie"), navigate("instagram_profile")]))
                    img_block("https://i.pravatar.cc/150?u=charlie")
                        css("w-full h-full rounded-full border-2 border-black object-cover")
                col()
                    css("flex-1 gap-0")
